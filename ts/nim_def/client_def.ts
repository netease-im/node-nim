...
export interface SDKConfig {
  ...
  lbs_backup_address_?: Array<string>
  ...
  nos_accelerate_host_list_?: Array<string>
  ...
  sync_data_type_list_?: Map<number /*key */, number /*value */>
  /** string list httpdns服务请求地址，如果没有特定地址可以不填 */
  http_dns_server_interface_?: Array<string>
  /** boolean 是否优先使用cdn域名 */
...
export interface LoginRes {
  ...
  relogin_?: boolean
  /** 登录步骤NIMLoginStep */
  login_step_?: NIMLoginStep
  /** 其他端的在线状态列表，登录成功才会返回这部分内容 */
  other_clients_?: Array<OtherClientPres>
...
export interface KickoutRes {
  ...
  kick_reason_?: NIMKickReason
  /** string 返回的被踢描述 */
  kickout_description_?: string
  /** 自定义客户端类型，若没有，服务器会填0 */
  custom_client_type_?: number
}
...
export interface MultiSpotLoginRes {
  ...
  notify_type_?: NIMMultiSpotNotifyType
  /** 其他端的在线状态列表 */
  other_clients_?: Array<OtherClientPres>
}
