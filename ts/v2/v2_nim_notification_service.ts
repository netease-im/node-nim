import { V2NIMBroadcastNotification, V2NIMCustomNotification, V2NIMError, V2NIMSendCustomNotificationParams } from 'ts/v2_def/v2_nim_struct_def'
...
/** @brief 通知服务 */
export class V2NIMNotificationService extends EventEmitter<V2NIMNotificationServiceEvents> {
    instance: any
    constructor() {
        super()
