...
import {
  NIMNOSAPI, NIMInitConfigParam, NIMNOSParams, NIMInitNosResultCallback, NIMDownloadMediaCallback, NIMUploadMediaExCallback,
  NIMProgressCallback, NIMSpeedCallback, NIMTransferInfoCallback, NIMProgressExCallback, NIMDownloadMediaExCallback,
  NIMsafe_urlToOriginURLCallback, NIMUploadMediaResult,
} from '../def/nos_def';
