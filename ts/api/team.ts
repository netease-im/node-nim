...
import {
  NIMTeamAPI, NIMTeamInfo, NIMTeamMemberProperty, NIMQueryAllMyTeamsCallback, NIMQueryAllMyTeamsInfoCallback, NIMQueryMyAllMemberInfosCallback,
  NIMQueryTeamMembersCallback, NIMQueryTeamMemberCallback, NIMQueryTeamInfoCallback, NIMTeamEventCallback, NIMQueryTeamMembersOnlineCallback,
  NIMQueryTeamMembersInvitorCallback, NIMQueryTeamsInfoCallback, NIMTeamMsgAckReadCallback, NIMGetTeamInfoBatchSFTransCallback,
  NIMGetTeamInfoListCallback, NIMUpdateTInfoLocalCallback, NIMTeamEvent,
} from '../def/team_def';
import nim from './nim';
...
export class NIMTeam extends ev.EventEmitter {
  ...
  /** 获取群禁言成员列表
     ...
     * </pre>
     */
  queryMuteListOnlineAsync(tid: string, cb: NIMQueryTeamMembersOnlineCallback, json_extension: string): boolean {
  ...
  /** 更新群信息
     ...
     * @return void
     */
  updateTInfoLocal(infos: Array<NIMTeamInfo>, cb: NIMUpdateTInfoLocalCallback, json_extension: string): void {
  ...
  /** 查询所有群
     ...
     * @return void 无返回值
     */
  getTeamInfoBatchTrans(cb: NIMGetTeamInfoBatchSFTransCallback, time_tag: number, json_extension: string): void {
