...
import {
  NIMUserAPI, NIMUserNameCard, NINPushType, NIMSpecialRelationshipChangeEvent, NIMSpecialRelationshipChangedCallback,
  NIMUserNameCardChangedCallback, NIMSetRelationCallback, NIMGetSpecialListCallback, NIMGetUserNameCardCallback,
  NIMUpdateMyUserNameCardCallback,
} from '../def/user_def';
