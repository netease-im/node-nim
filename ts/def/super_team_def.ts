...
export interface NIMSuperTeamInfo {
  ...
  be_invite_mode: NIMSuperTeamBeInviteMode; /** < int, 被邀请人同意方式，属性本身只有群主管理员可以修改,
                                            默认kNIMSuperTeamBeInviteModeNeedAgree(0)/kNIMSuperTeamBeInviteModeNotNeedAgree(1) */
  invite_mode: NIMSuperTeamInviteMode;	/** < int, 谁可以邀请他人入群，属性本身只有群主管理员可以修改,
                                            默认kNIMSuperTeamInviteModeManager(0)/kNIMSuperTeamInviteModeEveryone(1) */
  update_info_mode: NIMSuperTeamUpdateInfoMode;/** < int, 谁可以修改群资料，属性本身只有群主管理员可以修改,
                                            默认kNIMSuperTeamUpdateInfoModeManager(0)/kNIMSuperTeamUpdateInfoModeEveryone(1) */
  update_custom_mode: NIMSuperTeamUpdateCustomMode;/** < int, 谁可以更新群自定义属性，属性本身只有群主管理员可以修改,
                                                      默认kNIMSuperTeamUpdateCustomModeManager(0)/kNIMSuperTeamUpdateCustomModeEveryone(1) */
