...
client.login('45c6af3c98409b18a84451215d0bdd6e', 'zvc0', 'e10adc3949ba59abbe56e057f20f883e', (loginResult) => {
  console.log('loginResult', loginResult);
  if (loginResult.login_step_ == 3) {
    result = friend.request(test_info.assistUser, 1, 'Request msg', (res_code) => {
