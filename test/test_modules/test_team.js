  ...
  describe('********************Team********************', function() {
    ...
    describe('#createTeamAsync', function() {
      it('createTeamAsync', function (done) {
        team.createTeamAsync({team_info_json_value_:{
          name: 'Node_test',
          type: 1,
          member_max_count: 10,
        }}, [test_info.assistUser], '', function(result) {
    ...
    describe('#kickAsync', function() {
      it('kickAsync', function(done) {
        team.kickAsync(
            team_data.team_id_, [test_info.assistUser], function(result) {
              done();
            }, '');
      });
    });
    ...
    describe('#applyJoinAsync', function() {
      it('applyJoinAsync', function(done) {
        team.applyJoinAsync(
            team_data.team_id_, '', function(result) {
              done();
            }, '');
      });
    });
    describe('#passJoinApplyAsync', function() {
      it('passJoinApplyAsync', function(done) {
        team.passJoinApplyAsync(
            team_data.team_id_, test_info.mainUser, function(result) {
              done();
            }, '');
      });
    });
    ...
    describe('#transferTeamAsync', function() {
      it('transferTeamAsync', function(done) {
        team.transferTeamAsync(
            team_data.team_id_, test_info.mainUser, false, function(result) {
              done();
            }, '');
      });
    });
    ...
    describe('#queryTeamMembersAsync', function() {
      it('queryTeamMembersAsync', function(done) {
        team.queryTeamMembersAsync(team_data.team_id_, function(tid, count, result) {
          done();
        }, '');
      });
    });
    describe('#queryTeamMemberAsync', function() {
      it('queryTeamMemberAsync', function(done) {
        team.queryTeamMemberAsync(team_data.team_id_, test_info.mainUser, function(result) {
          done();
        }, '');
      });
    });
    describe('#queryTeamInfoAsync', function() {
      it('queryTeamInfoAsync', function(done) {
        team.queryTeamInfoAsync(team_data.team_id_, function(tid, result) {
          done();
        }, '');
      });
    });
    describe('#queryTeamInfoOnlineAsync', function() {
      it('queryTeamInfoOnlineAsync', function(done) {
        team.queryTeamInfoOnlineAsync(team_data.team_id_, function(result) {
          done();
        }, '');
      });
    });
    describe('#muteMemberAsync', function() {
      it('muteMemberAsync', function(done) {
        team.muteMemberAsync(team_data.team_id_, test_info.mainUser, false, function(result) {
          done();
        }, '');
      });
    });
    describe('#queryMuteListOnlineAsync', function() {
      it('queryMuteListOnlineAsync', function(done) {
        team.queryMuteListOnlineAsync(team_data.team_id_, function(rescode, count, result) {
          done();
        }, '');
      });
    });
    describe('#muteAsync', function() {
      it('muteAsync', function(done) {
        team.muteAsync(team_data.team_id_, false, function(result) {
          done();
        }, '');
      });
    });
    ...
    describe('#queryTeamMembersInvitor', function() {
      it('queryTeamMembersInvitor', function(done) {
        team.queryTeamMembersInvitor(team_data.team_id_, [], function(rescode, count, result) {
          done();
        }, '');
      });
    });
