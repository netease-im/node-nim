...
describe('******************** Utilities ********************', function () {
  ...
  describe('#createLocationMessageAttachment', function () {
    it('Create location message attachment should return a object',   function () {
      console.log(v2.messageAttachmentCreator)
      const result = v2.messageAttachmentCreator.createLocationMessageAttachment(123, 456, 'hello')
      assert.strictEqual(result.latitude, 123)
      assert.strictEqual(result.longitude, 456)
      assert.strictEqual(result.address, 'hello')
      assert.strictEqual(result.raw  != null, true)
    })
  })
})
