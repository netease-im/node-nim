...
describe('******************** Chatroom ********************', function () {
  ...
  describe('#setAppkey', function () {
    it('Set app key after entered should return with 191002', function () {
      const error = chatroomInstance.updateAppKey(GlobalVariables.onlineAppKey)
      assert.strictEqual(error.code, 190002)
    })
  })
