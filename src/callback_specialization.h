...
CallbackSpecialization(V2NIMSuccessCallback<const nstd::vector<V2NIMTeam>&>);
...
CallbackSpecialization(V2NIMSuccessCallback<const V2NIMTeamJoinActionInfoResult&>);
...
CallbackSpecialization(V2NIMSuccessCallback<const nstd::vector<nstd::shared_ptr<V2NIMAIUser>>&>);
