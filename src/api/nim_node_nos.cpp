...
NIM_SDK_NODE_API_DEF(NOS, RegDownloadCb) {
    ...
    auto callback = std::bind(&NOSEventHandler::OnDownloadMediaCallback, nullptr, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3,
                              std::placeholders::_4);
...
NIM_SDK_NODE_API_DEF(NOS, FetchMediaEx) {
    ...
    auto callback_2 = std::bind(&NOSEventHandler::OnDownloadMediaCallback, bcb_2, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3,
                                std::placeholders::_4);
