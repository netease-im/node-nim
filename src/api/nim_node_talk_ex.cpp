...
NIM_SDK_NODE_API_DEF(TalkEx, AddCollect) {
    ...
    nim_talkex_collect_info_obj_to_struct(isolate, args[0]->ToObject(isolate->GetCurrentContext()).ToLocalChecked(), collect_info);
...
NIM_SDK_NODE_API_DEF(TalkEx, RemoveCollects) {
    ...
    nim_talkex_collect_info_array_to_list(isolate, args[0]->ToObject(isolate->GetCurrentContext()).ToLocalChecked(), list);
    for (auto& collect : list.list) {
        param.Add(collect);
    }
    ASSEMBLE_BASE_CALLBACK(1);
    auto callback = std::bind(&TalkExEventHandler::OnRemoveCollectsCallback, bcb, std::placeholders::_1, std::placeholders::_2);
...
NIM_SDK_NODE_API_DEF(TalkEx, QueryCollectList) {
    ...
    ASSEMBLE_BASE_CALLBACK(1);
    auto callback = std::bind(&TalkExEventHandler::OnQueryCollectsCallback, bcb, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
...
NIM_SDK_NODE_API_DEF(TalkEx, RegAddQuickCommentNotify) {
    ...
    auto callback = std::bind(&TalkExEventHandler::OnAddQuickCommentNotifyCallback, std::placeholders::_1, std::placeholders::_2,
...
NIM_SDK_NODE_API_DEF(TalkEx, RegRemoveQuickCommentNotify) {
    ...
    auto callback = std::bind(&TalkExEventHandler::OnRemoveQuickCommentNotifyCallback, std::placeholders::_1, std::placeholders::_2,
...
NIM_SDK_NODE_API_DEF(TalkEx, AddQuickComment) {
    ...
    nim_talkex_quick_comment_info_obj_to_struct(isolate, args[1]->ToObject(isolate->GetCurrentContext()).ToLocalChecked(), info);
    ASSEMBLE_BASE_CALLBACK(2);
    auto bind_cb = std::bind(&TalkExEventHandler::OnAddQuickCommentCallback, bcb, std::placeholders::_1, std::placeholders::_2);
...
NIM_SDK_NODE_API_DEF(TalkEx, RemoveQuickComment) {
    ...
    nim_talkex_quick_comment_remove_param_obj_to_struct(isolate, args[1]->ToObject(isolate->GetCurrentContext()).ToLocalChecked(), param);
    ASSEMBLE_BASE_CALLBACK(2);
    auto bind_cb = std::bind(&TalkExEventHandler::OnRemoveQuickCommentCallback, bcb, std::placeholders::_1, std::placeholders::_2);
...
NIM_SDK_NODE_API_DEF(TalkEx, AddPinMessage) {
    ...
    nim_talkex_pin_info_obj_to_struct(isolate, args[1]->ToObject(isolate->GetCurrentContext()).ToLocalChecked(), info);
    ASSEMBLE_BASE_CALLBACK(2);
    auto bind_cb = std::bind(&TalkExEventHandler::OnPinMessageCallback, bcb, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3,
                             std::placeholders::_4);
...
NIM_SDK_NODE_API_DEF(TalkEx, UnPinMessage) {
    ...
    nim_talkex_modify_pin_info_obj_to_struct(isolate, args[0]->ToObject(isolate->GetCurrentContext()).ToLocalChecked(), param);
    ASSEMBLE_BASE_CALLBACK(1);
    auto bind_cb = std::bind(&TalkExEventHandler::OnUnPinMessageCallback, bcb, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3,
                             std::placeholders::_4);
...
NIM_SDK_NODE_API_DEF(TalkEx, QueryAllPinMessage) {
    ...
    ASSEMBLE_BASE_CALLBACK(2);
    auto bind_cb = std::bind(&TalkExEventHandler::OnQueryPinMessageCallback, bcb, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3,
                             std::placeholders::_4);
    nim::TalkEx::PinMsg::QueryAllPinMessage(session.toUtf8String(), to_type, bind_cb);
}

NIM_SDK_NODE_API_DEF(TalkEx, RegAddPinMessage) {
    CHECK_API_FUNC(TalkEx, 1);
    ASSEMBLE_REG_CALLBACK(0, TalkExEventHandler, "OnAddPinMessageNotifyCallback");
    auto callback =
        std::bind(&TalkExEventHandler::OnAddPinMessageNotifyCallback, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    nim::TalkEx::PinMsg::RegAddPinMessage(callback);
}

NIM_SDK_NODE_API_DEF(TalkEx, RegUnPinMessage) {
    CHECK_API_FUNC(TalkEx, 1);
    ASSEMBLE_REG_CALLBACK(0, TalkExEventHandler, "OnUnPinMessageNotifyCallback");
    auto callback = std::bind(&TalkExEventHandler::OnUnPinMessageNotifyCallback, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    nim::TalkEx::PinMsg::RegUnPinMessage(callback);
}

NIM_SDK_NODE_API_DEF(TalkEx, RegUpdatePinMessage) {
    CHECK_API_FUNC(TalkEx, 1);
    ASSEMBLE_REG_CALLBACK(0, TalkExEventHandler, "OnUpdatePinMessageNotifyCallback");
    auto callback =
        std::bind(&TalkExEventHandler::OnUpdatePinMessageNotifyCallback, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
