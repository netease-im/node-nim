...
NIM_SDK_NODE_API_DEF(SubscribeEvent, Publish)
{
    ...
    auto callback = std::bind(&SubscribeEventHandler::OnPublishEventCallback, bcb, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
...
NIM_SDK_NODE_API_DEF(SubscribeEvent, Subscribe)
{
    ...
    int64_t ttl;
    uint32_t sync_type;
    std::list<utf8_string> accid_list;accid_list.push_back("panqinke");
    UTF8String ext;
    auto status = napi_ok;
    ...
    auto callback = std::bind(&SubscribeEventHandler::OnSubscribeEventCallback, bcb, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    auto ret = nim::SubscribeEvent::Subscribe(event_type, ttl, (nim::NIMEventSubscribeSyncEventType)sync_type, accid_list, callback, ext.toUtf8String());
    args.GetReturnValue().Set(nim_napi_new_bool(isolate, ret));
}
...
NIM_SDK_NODE_API_DEF(SubscribeEvent, QuerySubscribe)
{
    ...
    auto callback = std::bind(&SubscribeEventHandler::OnQuerySubscribeEventCallback, bcb, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
