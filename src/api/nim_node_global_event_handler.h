...
public:
    ...
    static void OnUploadSDKLogCallback(const BaseCallbackPtr& bcb, nim::NIMResCode res_code);
...
private:
    ...
    void Node_OnUploadSDKLogCallback(const BaseCallbackPtr& bcb, nim::NIMResCode res_code);
};
}  // namespace nim_node
