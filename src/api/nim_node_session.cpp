...
void Session::InitModule(Local<Object>& module) {
    ...
    SET_PROTOTYPE(QueryAllRecentSessionAsync2);
...
NIM_SDK_NODE_API_DEF(Session, RegChangeCb) {
    ...
    SessionEventHandler::GetInstance()->AddEventHandler("OnChangeCallback",
                                                        pdata, pcb);
    ...
    auto callback = std::bind(&SessionEventHandler::OnChangeCallback, nullptr,
...
NIM_SDK_NODE_API_DEF(Session, RegBadgeCountCb) {
    ...
    Persistent<Object> pdata;
    pdata.Reset(isolate, obj);
    SessionEventHandler::GetInstance()->AddEventHandler("OnBadgeCountCallback",
                                                        pdata, pcb);
    ...
    auto callback = std::bind(&SessionEventHandler::OnBadgeCountCallback,
...
NIM_SDK_NODE_API_DEF(Session, RegSetToStickTopSessionNotifyCB) {
    ...
    ASSEMBLE_REG_CALLBACK(0, SessionEventHandler,
                          "OnSetToStickTopSessionNotifyCallback");
    auto callback =
        std::bind(&SessionEventHandler::OnSetToStickTopSessionNotifyCallback,
                  std::placeholders::_1);
...
NIM_SDK_NODE_API_DEF(Session, RegCancelStickTopSessionNotifyCB) {
    CHECK_API_FUNC(Session, 1);
    ASSEMBLE_REG_CALLBACK(0, SessionEventHandler,
                          "OnCancelStickTopSessionNotifyCallback");
    auto callback =
        std::bind(&SessionEventHandler::OnCancelStickTopSessionNotifyCallback,
                  std::placeholders::_1, std::placeholders::_2);
...
NIM_SDK_NODE_API_DEF(Session, RegUpdateStickTopSessionNotifyCB) {
    CHECK_API_FUNC(Session, 1);
    ASSEMBLE_REG_CALLBACK(0, SessionEventHandler,
                          "OnUpdateStickTopSessionNotifyCallback");
    auto callback =
        std::bind(&SessionEventHandler::OnUpdateStickTopSessionNotifyCallback,
                  std::placeholders::_1);
...
NIM_SDK_NODE_API_DEF(Session, QueryStickTopSessionList) {
    ...
    auto callback =
        std::bind(&SessionEventHandler::OnQueryStickTopSessionListCallback, bcb,
                  std::placeholders::_1, std::placeholders::_2);
...
NIM_SDK_NODE_API_DEF(Session, UpdateToStickTopSession) {
    ...
    auto callback =
        std::bind(&SessionEventHandler::OnUpdateStickTopSessionCallback, bcb,
                  std::placeholders::_1, std::placeholders::_2);
    nim::Session::UpdateToStickTopSession(
        session_id.toUtf8String(), static_cast<nim::NIMSessionType>(to_type),
        ext.toUtf8String(), callback);
}
...
NIM_SDK_NODE_API_DEF(Session, CancelToStickTopSession) {
    ...
    auto callback = std::bind(
        &SessionEventHandler::OnCancelToStickTopSessionCallback, bcb,
...
NIM_SDK_NODE_API_DEF(Session, SetToStickTopSession) {
    ...
    ASSEMBLE_BASE_CALLBACK(3);
    auto callback =
        std::bind(&SessionEventHandler::OnSetToStickTopSessionCallback, bcb,
                  std::placeholders::_1, std::placeholders::_2);
...
NIM_SDK_NODE_API_DEF(Session, QueryLastFewSessionAsync) {
    ...
    auto callback =
        std::bind(&SessionEventHandler::OnQuerySessionListCallabck, bcb,
                  std::placeholders::_1, std::placeholders::_2);
    nim::Session::QueryLastFewSessionAsync(limit, callback,
                                           exten.toUtf8String());
}
...
NIM_SDK_NODE_API_DEF(Session, QueryAllRecentSessionAsync2) {
    Session* instance = node::ObjectWrap::Unwrap<Session>(args.Holder());
    if (!instance) {
        return;
    }
    ...
    auto callback =
        std::bind(&SessionEventHandler::OnQuerySessionListCallabck, bcb,
                  std::placeholders::_1, std::placeholders::_2);
    nim::Session::QueryAllRecentSessionAsync((nim::NIMMessageType)(type),
...
NIM_SDK_NODE_API_DEF(Session, DeleteRecentSession) {
    ...
    auto callback = std::bind(&SessionEventHandler::OnChangeCallback, bcb,
                              std::placeholders::_1, std::placeholders::_2,
                              std::placeholders::_3);
    nim::Session::DeleteRecentSession((nim::NIMSessionType)(type),
                                      id.toUtf8String(), callback,
                                      exten.toUtf8String());
}
...
NIM_SDK_NODE_API_DEF(Session, DeleteSessionRoamingMessage) {
    ...
    ASSEMBLE_BASE_CALLBACK(2);
    auto callback = std::bind(
        &SessionEventHandler::OnDeleteSessionRoamingMessageCallback, bcb,
        std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    GET_ARGS_VALUE(isolate, 3, utf8string, ext);
    auto result = nim::Session::DeleteSessionRoamingMessage(
        static_cast<nim::NIMSessionType>(to_type), session_id.toUtf8String(),
...
NIM_SDK_NODE_API_DEF(Session, SetMultiUnreadCountZeroAsync) {
    ...
    nim_session_multi_unread_info_obj_to_struct(
        isolate,
        args[1]->ToObject(isolate->GetCurrentContext()).ToLocalChecked(),
        zero_list);
    ASSEMBLE_BASE_CALLBACK(2);
    auto callback = std::bind(
        &SessionEventHandler::OnSetMultiUnreadCountZeroCallback, bcb,
        std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    auto result = nim::Session::SetMultiUnreadCountZeroAsync(
        is_super_team, zero_list, callback);
    args.GetReturnValue().Set(Boolean::New(args.GetIsolate(), result));
}
...
NIM_SDK_NODE_API_DEF(Session, SetUnreadCountZeroAsync) {
    ...
    auto callback = std::bind(&SessionEventHandler::OnChangeCallback, bcb,
                              std::placeholders::_1, std::placeholders::_2,
                              std::placeholders::_3);
    nim::Session::SetUnreadCountZeroAsync((nim::NIMSessionType)(type),
                                          id.toUtf8String(), callback,
                                          exten.toUtf8String());
}
NIM_SDK_NODE_API_DEF(Session, SetSessionTop) {
    ...
    auto callback = std::bind(&SessionEventHandler::OnChangeCallback, bcb,
                              std::placeholders::_1, std::placeholders::_2,
                              std::placeholders::_3);
    nim::Session::SetSessionTop((nim::NIMSessionType)(type), id.toUtf8String(),
                                top, callback, exten.toUtf8String());
}
NIM_SDK_NODE_API_DEF(Session, SetSessionExtendData) {
    ...
    auto callback = std::bind(&SessionEventHandler::OnChangeCallback, bcb,
                              std::placeholders::_1, std::placeholders::_2,
                              std::placeholders::_3);
    nim::Session::SetSessionExtendData((nim::NIMSessionType)type,
                                       id.toUtf8String(), data.toUtf8String(),
                                       callback, exten.toUtf8String());
}
...
NIM_SDK_NODE_API_DEF(Session, QuerySessionDataById) {
    ...
    auto callback =
        std::bind(&SessionEventHandler::OnQuerySessionDataCallback, bcb,
                  std::placeholders::_1, std::placeholders::_2);
    nim::Session::QuerySessionDataById((nim::NIMSessionType)(type),
                                       id.toUtf8String(), callback,
                                       exten.toUtf8String());
}
...
NIM_SDK_NODE_API_DEF(Session, QueryHasmoreRoammsg) {
    ...
    ASSEMBLE_BASE_CALLBACK(2);
    auto callback =
        std::bind(&SessionEventHandler::OnQueryHasmoreRoammsgCallback, bcb,
                  std::placeholders::_1, std::placeholders::_2);
    nim::Session::QueryHasmoreRoammsg(session_id.toUtf8String(),
...
NIM_SDK_NODE_API_DEF(Session, QueryAllHasmoreRoammsg) {
    ...
    ASSEMBLE_BASE_CALLBACK(0);
    auto callback =
        std::bind(&SessionEventHandler::OnQueryAllHasmoreRoammsgCallback, bcb,
                  std::placeholders::_1, std::placeholders::_2);
...
NIM_SDK_NODE_API_DEF(Session, UpdateHasmoreRoammsg) {
    ...
    auto callback = std::bind(&SessionEventHandler::OnSessionBaseCallback, bcb,
                              std::placeholders::_1);
...
NIM_SDK_NODE_API_DEF(Session, DeleteHasmoreRoammsg) {
    ...
    auto callback = std::bind(&SessionEventHandler::OnSessionBaseCallback, bcb,
                              std::placeholders::_1);
    nim::Session::DeleteHasmoreRoammsg(
        session_id.toUtf8String(), static_cast<nim::NIMSessionType>(to_type),
        callback);
}
