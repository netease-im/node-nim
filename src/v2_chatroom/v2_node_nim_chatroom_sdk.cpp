...
Napi::Object node_nim::V2NodeNIMChatroomSdk::Init(Napi::Env env, Napi::Object exports) {
    return InternalInit("V2NIMChatroomSdk", env, exports,
        {RegApi("init", &V2NIMChatroomClient::init), RegApi("uninit", &V2NIMChatroomClient::uninit),
            RegApi("destroyInstance", &V2NIMChatroomClient::destroyInstance), RegApi("destroyAll", &V2NIMChatroomClient::destroyAll),
