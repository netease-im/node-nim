...
ReflectionDefinition_O(QChatServerEnterAsVisitorResp, res_code, failed_servers);
ReflectionDefinition_O(QChatServerLeaveAsVisitorResp, res_code, failed_servers);
...
ReflectionDefinition_O(QChatServerSubscribeAsVisitorResp, res_code, failed_servers);
...
ReflectionDefinition_O(QChatServerEnterAsVisitorParam, cb, server_ids);
ReflectionDefinition_O(QChatServerLeaveAsVisitorParam, cb, server_ids);
...
ReflectionDefinition_O(QChatServerSubscribeAsVisitorParam, cb, ope_type, server_ids);
