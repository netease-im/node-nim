    ...
    "targets": [
        {
            ...
            'sources': [
                ...
                'src/api/nim_node_rts.h',
                'src/api/nim_node_rts.cpp',
                'src/api/nim_node_rts_event_handler.h',
                'src/api/nim_node_rts_event_handler.cpp',
                'src/helper/nim_node_rts_helper.h',
                'src/helper/nim_node_rts_helper.cpp',
                ...
                'src/api/nim_node_signaling.h',
                'src/api/nim_node_signaling.cpp',
                'src/api/nim_node_signaling_event_handler.h',
                'src/api/nim_node_signaling_event_handler.cpp',
                'src/helper/nim_node_signaling_helper.h',
                'src/helper/nim_node_signaling_helper.cpp',
            ],
            'conditions': [
                [
                    'OS=="win"',
